package com.systems.community.carpooling.southpoolsecurity.entities;
...
@Setter
@Entity
@Table(name="user_massages")
public class UserMessages implements Serializable, Member {
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -1375454511720112485L;
