package com.systems.community.carpooling.southpoolsecurity.persistence.service;
...
import com.systems.community.carpooling.southpoolsecurity.entities.Member;
import com.systems.community.carpooling.southpoolsecurity.persistence.dao.MemberDAO;
...
public class PersistenceServiceImpl implements PersistenceService {
	...
	@Override
	public <T extends Member> List<T> getMemberMessages(Map<String, String> predicatesMap, Class<T> clazz) {
		return memberDao.getMemberMessages(predicatesMap, clazz);
	}
}
